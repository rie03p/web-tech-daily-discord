...
SOURCES = [
    ...
    {"id": "google-cloud", "name": "Google Cloud", "url": "https://docs.cloud.google.com/feeds/gcp-release-notes.xml", "topics": ["google cloud", "cloud", "ai"]},
    ...
    {"id": "openai", "name": "OpenAI Python SDK", "url": "https://github.com/openai/openai-python/releases.atom", "topics": ["openai", "ai", "api", "python sdk"]},
]
